...
static bool prv_encode_unsigned_integer(sTicosCborEncoder *encoder, uint8_t major_type,
                                        uint32_t val) {
...
bool ticos_cbor_encode_uint64_as_double(sTicosCborEncoder *encoder, uint64_t val) {
  uint8_t tmp_buf[TICOS_CBOR_UINT64_MAX_ITEM_SIZE_BYTES];
...
bool ticos_cbor_join(sTicosCborEncoder *encoder, const void *cbor_data,
