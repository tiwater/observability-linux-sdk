...
//!
//!
//! Since the actual CBOR serialization feature set needed by the SDK is a tiny subset of the CBOR
//! RFC, a minimal implementation is implemented here.
...
typedef void(TicosCborWriteCallback)(void *ctx, uint32_t offset, const void *buf,
                                        size_t buf_len);
