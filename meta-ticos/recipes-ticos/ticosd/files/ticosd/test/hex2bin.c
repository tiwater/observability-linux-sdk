...
uint8_t *ticos_hex2bin(const char *hex_string, size_t *out_len) {
...
void ticos_hex2bin_file(const char *output_path, const char *hex_contents) {
  size_t contents_size;
  uint8_t *const contents = ticos_hex2bin(hex_contents, &contents_size);
